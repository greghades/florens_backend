...
from .serializers import ReportSerializer, AttentionSerializer, MedicalOrderSerializer, WorkstationSerializer
from .models import Report, AttentionOrder, WorkStation
...
#Registrar/crear una atencion correspondiente a una orden medica
...
class CreateAttention(Authentication,CreateAPIView):
    ...
    def create(self, request):
        ...
        try:
            ...
            #En las siguiente lineas se modifica update_att en la orden medica
